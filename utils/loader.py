...
import glob
from .helper import id_matching, compute_focal_length, rigid_transform_3D
...
class PanopticLoader():
    def __init__(self, classes2category_json='/usr/wiss/dendorfp/dvl/projects/TrackingMOT/classes2category.json',
