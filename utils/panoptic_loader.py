...
class PanopticLoader():
    def __init__(self, classes2category_json='/usr/stud/yugay/MOT16_helper_code/classes2category.json',
                 meta_data_classes_pkl="/usr/stud/yugay/MOT16_helper_code/metaDataClasses.pkl"):
    ...
    def get_panoptic_img_MOTSynth(self, panoptic_png, exclude_categories: List[str] = [], include_categories: List[str] = []):
        ...
        panoptic_mask = np.zeros(
            (panoptic_png.shape[0], panoptic_png.shape[1]))
        for color in colors:
